...
<div class="card">
  <div class="card-header">
        <a href="{{ url('/contacts/create') }}"><button class="btn btn-primary">Add a new contact to the list</button></a>
    <br/>
  </div>
        ...
        <thead>
            ...
            @foreach($contacts as $item)
                <tr>
                    ...
                    <td>{{ $item->country }}</td>
                    <td>
                        <a href="{{ url('/contacts/' . $item->id . '/edit') }}" title="Edit"><button class="btn btn-warning">
